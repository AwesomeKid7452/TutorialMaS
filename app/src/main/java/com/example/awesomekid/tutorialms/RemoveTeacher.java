...
public class RemoveTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            HttpPost httpPost = new HttpPost("http://tutorialmanasys.site88.net/teacherList.php");
        ...
        try{
            ...
            arr = temp.split(":");
            spRemove.setAdapter(new ArrayAdapter<String>(RemoveTeacher.this, android.R.layout.simple_expandable_list_item_1, arr));
        ...
        bRemove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Response.Listener<String> responseListener = new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if (success){
                                AlertDialog.Builder alertDialog = new AlertDialog.Builder(RemoveTeacher.this);
                                alertDialog.setTitle("Remove Teacher");
                                alertDialog.setMessage("Teacher " + username + " successfully removed");
                ...
                RequestQueue queue = Volley.newRequestQueue(RemoveTeacher.this);
